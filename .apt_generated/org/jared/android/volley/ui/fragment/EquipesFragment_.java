...
public final class EquipesFragment_
    extends EquipesFragment
{
    ...
    private void init_(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("EquipesFragment_", "Could not create DAO", e);
        }
    }
    ...
    public static EquipesFragment_.FragmentBuilder_ builder() {
        return new EquipesFragment_.FragmentBuilder_();
    }
    ...
    public void updateUIAsync() {
        handler_.post(new Runnable() {
            ...
            public void run() {
                try {
                    EquipesFragment_.super.updateUIAsync();
                } catch (RuntimeException e) {
                    Log.e("EquipesFragment_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public void updateFromNetWork() {
        BackgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    EquipesFragment_.super.updateFromNetWork();
                } catch (RuntimeException e) {
                    Log.e("EquipesFragment_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public static class FragmentBuilder_ {
        ...
        public EquipesFragment build() {
            EquipesFragment_ fragment_ = new EquipesFragment_();
