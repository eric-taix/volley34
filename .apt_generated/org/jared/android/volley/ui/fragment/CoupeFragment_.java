...
public final class CoupeFragment_
    extends CoupeFragment
{
    ...
    private void init_(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("CoupeFragment_", "Could not create DAO", e);
        }
    }
    ...
    public static CoupeFragment_.FragmentBuilder_ builder() {
        return new CoupeFragment_.FragmentBuilder_();
    }
    ...
    public void updateUIAsync() {
        handler_.post(new Runnable() {
            ...
            public void run() {
                try {
                    CoupeFragment_.super.updateUIAsync();
                } catch (RuntimeException e) {
                    Log.e("CoupeFragment_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public void updateFromNetWork() {
        BackgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    CoupeFragment_.super.updateFromNetWork();
                } catch (RuntimeException e) {
                    Log.e("CoupeFragment_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public static class FragmentBuilder_ {
        ...
        public CoupeFragment build() {
            CoupeFragment_ fragment_ = new CoupeFragment_();
