...
public final class ClubsFragment_
    extends ClubsFragment
{
    ...
    private void init_(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("ClubsFragment_", "Could not create DAO", e);
        }
    }
    ...
    public static ClubsFragment_.FragmentBuilder_ builder() {
        return new ClubsFragment_.FragmentBuilder_();
    }
    ...
    public void updateUIAsync() {
        handler_.post(new Runnable() {
            ...
            public void run() {
                try {
                    ClubsFragment_.super.updateUIAsync();
                } catch (RuntimeException e) {
                    Log.e("ClubsFragment_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public void updateFromNetWork() {
        BackgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ClubsFragment_.super.updateFromNetWork();
                } catch (RuntimeException e) {
                    Log.e("ClubsFragment_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
    ...
    public static class FragmentBuilder_ {
        ...
        public ClubsFragment build() {
            ClubsFragment_ fragment_ = new ClubsFragment_();
